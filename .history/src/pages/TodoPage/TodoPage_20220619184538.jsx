...
export const TodoPage = () => {
    ...
    const addColumn = useSelector(state => state.todo.isShowColumn)
    ...
    return (
      <>
        ...
        <Main>
          {addColumn && <TodoBoard/> || <AddTodo onClick={addColumnHandler}><div><img src={plus}/>Add another list</div></AddTodo>}
        </Main>
      </>
    ); 
}
