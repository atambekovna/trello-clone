...
import { todoActions } from '../../store/slices/authSlice'
import { TodoBoard } from './TodoBoard'

export const TodoPage = () => {

    // const {isAuth} = useAuth()
    const column = useSelector(state => state.todo.isShowColumn)
    const dispatch = useDispatch()

    const addColumn = () => {
        dispatch(todoActions.showColumn())
    }
    ...
    return (
      <>
        ...
        <Main>
          {column && <TodoBoard/> || <AddTodo onClick={addColumn}><div><img src={plus}/>Add another list</div></AddTodo>}
        </Main>
      </>
    ); 
}
