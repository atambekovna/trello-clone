...
export const TodoPage = () => {
    ...
    const addBoard = useSelector(state => state.todo.isShowColumn)
    ...
    return (
      <>
        ...
        <Main>
          {addBoard && <TodoBoard/> || <AddTodo onClick={addBoardHandler}><div><img src={plus}/>Add another list</div></AddTodo>}
        </Main>
      </>
    ); 
}
