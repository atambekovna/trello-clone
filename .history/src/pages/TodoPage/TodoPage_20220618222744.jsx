      ...
      <>
        <TodoHeader>
          <BtnBlock>
            <img src={menu} />
            <Logo src={logo} />
            <Button>Workspaces<img src={down} /></Button><Button>Recent<img src={down} /></Button><Button>Favorites<img src={down} /></Button><Button>Templates<img src={down} /></Button>
          </BtnBlock>
          <SearchBlock>
        ...
        <Main>
          {column && <TodoColumn/> || <AddTodo onClick={addColumn}><div><img src={plus}/>Add another column</div></AddTodo>}
        </Main>
      </>
    ); 
}
